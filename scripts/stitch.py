...
print("Stitching videos side-by-side...")
cap1 = cv2.VideoCapture("../vision_bench_selfDRIVING_pretrained_roi0.30.mp4")
cap2 = cv2.VideoCapture("../vision_bench_selfDRIVING_roi0.30.mp4")
...
out = cv2.VideoWriter("../side_by_side_comparison.mp4", cv2.VideoWriter_fourcc(*"mp4v"), fps, (w1+w2, max(h1, h2)))
...
cap2.release()
out.release()
print("Done! Saved to side_by_side_comparison.mp4")
