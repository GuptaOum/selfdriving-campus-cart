...
<p align="center">
  <img src="docs/results/pi_segmented_output.gif" width="48%" alt="Live Campus Segmentation"/>
  <img src="docs/results/bw_mask_output.gif" width="48%" alt="Real-Time B&W Road Mask"/>
  <br/>
  <em><b>Dual-View Real-Time Edge Inference (~7.5 FPS on Raspberry Pi 4B):</b> Left: Camera view with Fast-SCNN drivable corridor overlay. Right: Extracted Black & White binary road mask fed into the geometric planner.</em>
</p>
